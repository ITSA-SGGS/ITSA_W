-- ============================================================================
-- ITSA WEB PLATFORM — SEED DATA SCRIPT
-- Imports official organizational positions, current 2026-2027 committee members,
-- 5 authentic archive photographs, and baseline site settings.
-- NO student registration numbers are present.
-- ============================================================================
...
INSERT INTO public.positions (name, tier, domain, description, display_order, is_active)
VALUES
  -- Core Committee
...
-- 3. OFFICIAL COMMITTEE MEMBERS (ACADEMIC YEAR 2026–2027)
INSERT INTO public.committee_members (name, position, tier, domain, photo_url, tenure_year, display_order, is_active)
VALUES
  -- Core Committee
  ('Tanishq Raut', 'President', 'CORE', 'OVERALL', '/team/tanishq-raut.jpg', '2026–2027', 1, true),
  ('Rahul Gulade', 'Vice President', 'CORE', 'OVERALL', '/team/rahul-gulade.jpg', '2026–2027', 2, true),
  ('Palak Baladwa', 'Vice President', 'CORE', 'OVERALL', '/team/palak-baladwa.jpg', '2026–2027', 3, true),
  ('Alok Singh', 'Treasurer', 'CORE', 'FINANCE', '/team/alok-singh.jpg', '2026–2027', 4, true),
  ('Aryan Kale', 'Vice Treasurer', 'CORE', 'FINANCE', '/team/aryan-kale.jpg', '2026–2027', 5, true),

  -- TY Leadership
  ('Nandini Chintewad', 'Technical Head', 'TY_LEADERSHIP', 'TECHNICAL', '/team/nandini-chintewad.jpg', '2026–2027', 6, true),
  ('Pradnya Jadhav', 'Technical Co-Head', 'TY_LEADERSHIP', 'TECHNICAL', '/team/pradnya-jadhav.jpg', '2026–2027', 7, true),
  ('Diksha Yelage', 'Event Operations Head', 'TY_LEADERSHIP', 'OPERATIONS', '/team/diksha-yelage.jpg', '2026–2027', 8, true),
  ('Ghananil Shirpurkar', 'Event Operations Co-Head', 'TY_LEADERSHIP', 'OPERATIONS', '/team/ghananil-shirpurkar.jpg', '2026–2027', 9, true),
  ('Aditya Mirajgave', 'Media Head', 'TY_LEADERSHIP', 'MEDIA', '/team/aditya-mirajgave.jpg', '2026–2027', 10, true),
  ('Mrunal Raje', 'Media Co-Head', 'TY_LEADERSHIP', 'MEDIA', '/team/mrunal-raje.jpg', '2026–2027', 11, true),
  ('Shrish Wadgaonkar', 'Anchoring Head', 'TY_LEADERSHIP', 'ANCHORING', '/team/shrish-wadgaonkar.jpg', '2026–2027', 12, true),
  ('Shravani Kharwadkar', 'Anchoring Co-Head', 'TY_LEADERSHIP', 'ANCHORING', '/team/shravani-kharwadkar.jpg', '2026–2027', 13, true),
  ('Yash Bangalkar', 'Sports Head', 'TY_LEADERSHIP', 'SPORTS', '/team/yash-bangalkar.jpg', '2026–2027', 14, true),
  ('Vardhan Wanjari', 'Sports Co-Head', 'TY_LEADERSHIP', 'SPORTS', '/team/vardhan-wanjari.jpg', '2026–2027', 15, true),
  ('Dharmaraj Deshmukh', 'Alumni & Relations Head', 'TY_LEADERSHIP', 'ALUMNI', '/team/dharmaraj-deshmukh.jpg', '2026–2027', 16, true),
  ('Mayuri Awalwar', 'Alumni & Relations Co-Head', 'TY_LEADERSHIP', 'ALUMNI', '/team/mayuri-awalwar.jpg', '2026–2027', 17, true),

  -- SY Coordinators
  ('Anand Soni', 'Main Coordinator', 'SY_COORDINATOR', 'OVERALL', '/team/anand-soni.jpg', '2026–2027', 18, true),
  ('Sarangi Aware', 'Main Coordinator', 'SY_COORDINATOR', 'OVERALL', '/team/sarangi-aware.jpg', '2026–2027', 19, true),
  ('Swarali Kulkarni', 'Joint Coordinator', 'SY_COORDINATOR', 'OVERALL', '/team/swarali-kulkarni.jpg', '2026–2027', 20, true),
  ('Samir Singh', 'Joint Coordinator', 'SY_COORDINATOR', 'OVERALL', '/team/samir-singh.jpg', '2026–2027', 21, true),
  ('Pratik Bisen', 'Technical Main Coordinator', 'SY_COORDINATOR', 'TECHNICAL', '/team/pratik-bisen.jpg', '2026–2027', 22, true),
  ('Dipak Bhondekar', 'Technical Joint Coordinator', 'SY_COORDINATOR', 'TECHNICAL', '/team/dipak-bhondekar.jpg', '2026–2027', 23, true),
  ('Shravani Dhole', 'Anchoring Main Coordinator', 'SY_COORDINATOR', 'ANCHORING', '/team/shravani-dhole.jpg', '2026–2027', 24, true),
  ('Gayatri Yadav', 'Anchoring Joint Coordinator', 'SY_COORDINATOR', 'ANCHORING', '/team/gayatri-yadav.jpg', '2026–2027', 25, true),
  ('Lokesh Badgujar', 'Media Main Coordinator', 'SY_COORDINATOR', 'MEDIA', '/team/lokesh-badgujar.jpg', '2026–2027', 26, true),
  ('Harsh Chandak', 'Media Joint Coordinator', 'SY_COORDINATOR', 'MEDIA', '/team/harsh-chandak.jpg', '2026–2027', 27, true),
  ('Chirag Turkar', 'Finance Main Coordinator', 'SY_COORDINATOR', 'FINANCE', '/team/chirag-turkar.jpg', '2026–2027', 28, true),
  ('Krushnal Gawande', 'Finance Joint Coordinator', 'SY_COORDINATOR', 'FINANCE', '/team/krushnal-gawande.jpg', '2026–2027', 29, true),
  ('Umair Khan', 'Sports Main Coordinator', 'SY_COORDINATOR', 'SPORTS', '/team/umair-khan.jpg', '2026–2027', 30, true),
  ('Shrinivas Thakur', 'Sports Joint Coordinator', 'SY_COORDINATOR', 'SPORTS', '/team/shrinivas-thakur.jpg', '2026–2027', 31, true),
  ('Mayuri Kadam', 'Alumni & Relations Main Coordinator', 'SY_COORDINATOR', 'ALUMNI', '/team/mayuri-kadam.jpg', '2026–2027', 32, true),

  -- Faculty Dignitaries
  ('Dr. Ankush Sawarkar', 'ITSA Faculty Coordinator', 'FACULTY', 'OVERALL', '/team/dr-ankush-sawarkar.jpg', '2026–2027', 33, true),
  ('Dr. C. P. Navdeti', 'Head of the Department', 'FACULTY', 'OVERALL', '/team/dr-cp-navdeti.jpg', '2026–2027', 34, true),
  ('Dr. M. V. Vaidya', 'Dean Student Activities', 'FACULTY', 'OVERALL', '/team/dr-mv-vaidya.jpg', '2026–2027', 35, true);
...
UPDATE public.committee_members SET department = 'SGGSIE&T, Nanded' WHERE name = 'Dr. M. V. Vaidya';

-- 4. AUTHENTIC ARCHIVE PHOTOGRAPHIC RECORDS (5 REAL IMAGES)
INSERT INTO public.archive_records (title, description, image_url, year, event_name, display_order, is_published)
VALUES
...
-- 5. BASELINE SAMPLE EVENTS
INSERT INTO public.events (title, description, category, year, status, is_published, display_order)
VALUES
