    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full my-auto flex flex-col justify-center">
        <div className="max-w-3xl lg:max-w-4xl">
          ...
          <div className="inline-flex items-center gap-3 mb-8 px-3.5 py-1.5 rounded-full bg-black/[0.04] dark:bg-white/[0.04] border border-black/10 dark:border-white/10 text-xs font-mono tracking-wider dark:text-[#A1A1A6] text-[#48484E]">
